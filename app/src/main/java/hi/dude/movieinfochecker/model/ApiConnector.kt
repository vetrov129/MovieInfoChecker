...
import hi.dude.movieinfochecker.model.entities.ListOfMovie
import hi.dude.movieinfochecker.model.entities.ListOfResult
    ...
    private suspend fun getJson(request: REQUEST, vararg params: String): String {
        while (true) {
            ...
            try {
                ...
                Log.e("ApiConnector", "getJson: $url error ${e.message}")
                return ""
            }
